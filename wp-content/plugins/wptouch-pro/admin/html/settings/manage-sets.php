<div id="manage-sets">	
	...
	<div id="manage-info-area">
		...
		<p>
			...
			<?php echo sprintf( __( '%sDownload WPtouch Pro Icon Template%s (PSD)', 'wptouch-pro' ), '<a href="' . WPTOUCH_URL . '/include/images/bookmark_icon_template.zip">', '</a>' ); ?><br />
			<?php echo sprintf( __( '%sDownload WPtouch Pro iPhone 4 & iPad Icon Template%s (PSD)', 'wptouch-pro' ), '<a href="' . WPTOUCH_URL . '/include/images/retina_bookmark_icon_template.zip">', '</a>' ); ?>
		</p>
	</div>

	...
	function widget( $args, $instance ) {
		...
		if ( ( ! empty( $instance['ad_url'] ) )
			...
			if ( $instance['sidebarname'] == "Ads Sidebar" ) {
				...
				$h4_styles = 'style="background-color:' . $instance['header-color'] . '!important; color:' . $instance['header-text'] . '!important;"';
				$div_styles = 'style="background-color:' . $instance['header-color'] . '!important;"';
				?>

				<div class="widgetwrap" style="-moz-box-shadow: none !important; -webkit-box-shadow: none !important; box-shadow: none !important;">

					<?php if ( $showtitle == 'on' ) { ?>
					<h4 <?php if ( $customcolors == 'on' ) { echo $h4_styles; } ?> class="widget3">
					...
					<div class="widgetbody3" style="background:none!important; padding:0!important;">
						...
						if ( $instance['ad-type'] == "Ad Tag" ) {
							...
							$openxcode = targetted_ad_code($instance['godengo-adtag']);
						...
						<a target="_blank" href="<?php echo $instance['link_url']; ?>">
							<img src="<?php echo $instance['ad_url']; ?>" style="width:<?php echo $instance['adwidth']; ?>"/>
						</a>
					...
					<?php if ( $showtitle == 'on' ) { ?>
					<div <?php if ( $customcolors == 'on' ) { echo $div_styles; } ?> class="widgetfooter3"></div>
					<?php } else { ?>

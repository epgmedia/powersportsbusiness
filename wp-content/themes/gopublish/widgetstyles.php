...
<?php if ( $instance['widget-style'] == "Style 1" ) { ?>
	...
	<h4 class="widget1" <?php if ($customcolors == on) { ?>style="
		...
		"<?php } ?>>
		<?php if ( $categoryslug ) { ?>
			<a <?php if ($customcolors
			             == on) { ?>style="color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>
...
<?php } else if ( $instance['widget-style'] == "Style 4" ) {
	...
	if ( ( $instance['sidebarname'] == "Home Bottom Left" )
	     || ( $instance['sidebarname'] == "Home Bottom Right" )
	) {
		$wrap      = "homecolumntop.gif";
		$wrapwidth = "280px";
	} else if ( ( $instance['sidebarname'] == "Home Sidebar" )
	...
	<?php } ?>
		">
		<h4 class="widget4" <?php if ($customcolors
		                              == on) { ?>style="background-color: <?php echo $instance['header-color']; ?> !important; color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>>
			<?php if ( $categoryslug ) { ?>
				<a <?php if ($customcolors
				             == on) { ?>style="color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>
				   href="<?php echo $categoryslug; ?>"><?php if ( $videotitle ) {
						echo $videotitle;
					} else {
						echo $categoryname;
					} ?>
